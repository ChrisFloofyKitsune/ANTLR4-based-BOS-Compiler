...
varStatement: VAR varName (COMMA varName)* SEMICOLON;
...
expression
    ...
    | term
    | op=(OP_MINUS | LOGICAL_NOT) operand0=expression
    | operand0=expression op=(OP_MULT | OP_DIV | OP_MOD) operand1=expression
    | operand0=expression op=(OP_ADD | OP_MINUS) operand1=expression
    | operand0=expression op=(COMP_LESS | COMP_GREATER | COMP_LESS_EQUAL | COMP_GREATER_EQUAL) operand1=expression
    | operand0=expression op=(COMP_EQUAL | COMP_NOT_EQUAL) operand1=expression
    | operand0=expression op=BITWISE_AND operand1=expression
    | operand0=expression op=BITWISE_OR operand1=expression
    | operand0=expression op=BITWISE_XOR operand1=expression
    | operand0=expression op=LOGICAL_AND operand1=expression
    | operand0=expression op=LOGICAL_OR operand1=expression
    | operand0=expression op=LOGICAL_XOR operand1=expression
    ;

term        : varyingTerm | constTerm;
varyingTerm : getTerm | rand | varName;
constTerm   : constant | unknown_unit_value | L_PAREN constTerm R_PAREN;
